...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
    ...
    return {
        ...
        alternates: {
            canonical: generateCanonical(locale, "/visa-glossary"),
        },
    };
}
...
export default async function VisaGlossaryHubPage({ params }: { params: Promise<{ locale: string }> }) {
            ...
            content: (
                <div className="space-y-4">
                    ...
                    <ul className="list-disc pl-6 space-y-2">
                        <li><strong><a href={formatNavLink(locale, "/visa-glossary/what-is-kitas")} className="text-primary hover:underline">KITAS (Limited Stay Permit)</a></strong>: The most common residency card for foreign workers, investors, and family members.</li>
        ...
        },
        {
            ...
            content: (
                <div className="space-y-4">
                    ...
                    <ul className="list-disc pl-6 space-y-2">
                        <li><strong><a href={formatNavLink(locale, "/visa-glossary/what-is-voa")} className="text-primary hover:underline">Visa on Arrival (VoA)</a></strong>: A 30-day tourist permit obtained at the airport.</li>
                        <li><strong><a href={formatNavLink(locale, "/visa-glossary/what-is-b211a")} className="text-primary hover:underline">B211A (Single Entry Visit Visa)</a></strong>: A versatile 60-day visa for business or tourism.</li>
                        <li><strong><a href={formatNavLink(locale, "/visa-glossary/what-is-business-visa")} className="text-primary hover:underline">Business Visa (Multiple Entry)</a></strong>: A 1-2 year visa for professionals making frequent business trips.</li>
        ...
        },
        {
            ...
            content: (
                <div className="space-y-4">
                    ...
                    <ul className="list-disc pl-6 space-y-2">
                        <li><strong><a href={formatNavLink(locale, "/visa-glossary/what-is-investor-visa")} className="text-primary hover:underline">Investor KITAS</a></strong>: A stay permit for foreign shareholders in Indonesian PMA companies.</li>
    ...
    return (
        <SEOPageLayout
            ...
            breadcrumbs={[
                { label: "Home", url: formatNavLink(locale, "/") },
