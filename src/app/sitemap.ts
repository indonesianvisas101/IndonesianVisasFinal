...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
    ...
    const pages = [
        ...
        '/indonesian-visas-in-2026-2027-all-types-and-prices',
        '/bali-visas-in-2026-2027-all-types-and-prices',
        '/jakarta-visas-in-2026-2027-all-types-and-prices',
        '/indonesian-visas-lates-updated',
        ...
        '/id-card-for-foreigner-in-indonesia',
        '/ktp-for-foreigner-in-indonesia',
        '/family-card-for-foreigner-in-indonesia',
        '/how-to-get-id-card-in-indonesia',
        '/id-card-for-foreigner-in-bali',
        '/new-zealand',
        '/micronesia',
        '/services/Bali',
        '/services/Jakarta',
