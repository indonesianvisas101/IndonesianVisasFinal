    ...
    const fetchFinanceData = async () => {
        ...
        try {
            ...
            if (res.ok) {
                ...
                const appsWithInvoices = data.filter((app: any) => app.invoice);
            ...
            <Grid container spacing={3} mb={4}>
                <Grid size={{ xs: 12, sm: 3 }}>
                    <Paper sx={{ p: 2, bgcolor: 'primary.light', color: 'primary.contrastText', borderRadius: 2 }}>
                        <Typography variant="caption" sx={{ opacity: 0.8, fontWeight: 'bold' }}>Total Service Revenue</Typography>
                ...
                <Grid size={{ xs: 12, sm: 3 }}>
                    <Paper sx={{ p: 2, bgcolor: 'warning.light', color: 'warning.contrastText', borderRadius: 2 }}>
                        <Typography variant="caption" sx={{ opacity: 0.8, fontWeight: 'bold' }}>PPh 23 Tax Collected</Typography>
                ...
                <Grid size={{ xs: 12, sm: 3 }}>
                    <Paper sx={{ p: 2, bgcolor: 'error.light', color: 'error.contrastText', borderRadius: 2 }}>
                        <Typography variant="caption" sx={{ opacity: 0.8, fontWeight: 'bold' }}>Gateway Fees Incurred</Typography>
                ...
                <Grid size={{ xs: 12, sm: 3 }}>
                    <Paper sx={{ p: 2, bgcolor: 'success.light', color: 'success.contrastText', borderRadius: 2 }}>
                        <Typography variant="caption" sx={{ opacity: 0.8, fontWeight: 'bold' }}>Grand Total (Cash In)</Typography>
