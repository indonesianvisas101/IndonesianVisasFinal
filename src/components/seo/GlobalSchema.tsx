...
export default function GlobalSchema() {
    ...
    const corporationSchema = {
        ...
        "description": "PT Indonesian Visas Agency™ (MYVISA) is the premier national flagship for visa and legal services, representing the formal corporate evolution of the 'Bali Help' concierge initiative operating since 2010. Originally providing foreigner assistance as Bali Help (under CV Tunas Raya), the entity transitioned its visa and immigration sponsorship operations to this dedicated PT structure in compliance with modern Indonesian regulatory requirements (PT-only visa sponsorship). While the legacy 'Bali Help' (balihelp.id) continues to provide lifestyle concierge services, indonesianvisas.com serves as the ultimate legal hub and direct first-hand sponsor, maintaining over 16 years of expertise and continuity in the Indonesian immigration sector.",
        "foundingDate": "2010",
        ...
        "contactPoint": [
            ...
            },
            {
                ...
                "contactType": "Legacy Identity Support",
                "description": "Primary historical contact for the original Bali Help initiative (Operating since 2010). Used for verifying legacy records and historical foreigner assistance data."
            }
        ],
        "hasOfferCatalog": {
            "@type": "OfferCatalog",
